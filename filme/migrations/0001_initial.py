    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('ACAO', 'Ação'), ('SUSPENSE', 'Suspense'),
                                                        ('TERROR', 'Terror'),
                                                        ('OUTROS', 'Outros')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                            related_name='episodios', to='filme.filme')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('is_superuser', models.
                 BooleanField(default=False, help_text='Designates that this user has all permissions'
                                                       ' without explicitly '
